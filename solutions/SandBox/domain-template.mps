...
<model modelUID="r:515dba64-8650-4942-8420-4e9bdebe9ef3(domain-template)">
  ...
  <node type="org.metaforms.domain.structure.CreditClass:7" id="4659346734374069115">
    <property name="name:7" value="Просто деньги" />
    <property name="id:7" value="JustMoney" />
    <node role="documentReference:7" type="org.metaforms.domain.structure.DocumentReference:7" id="4659346734374069124">
      <link role="document:7" targetNodeId="4659346734374069117" resolveInfo="Общее" />
    </node>
  </node>
  <node type="org.metaforms.domain.structure.Document:7" id="4659346734374069117">
    <property name="name:7" value="Общее" />
    <property name="id:7" value="Common" />
    <node role="field:7" type="org.metaforms.domain.structure.Field:7" id="4659346734374069118">
